...
// node_modules/@xrpl-wallet-standard/react/dist/index.mjs
...
// node_modules/@xrpl-wallet-standard/react/node_modules/tslib/tslib.es6.mjs
...
// node_modules/@xrpl-wallet-standard/react/node_modules/styled-components/dist/styled-components.browser.esm.js
...
// node_modules/@xrpl-wallet-standard/react/node_modules/@radix-ui/react-dialog/dist/index.mjs
...
// node_modules/@xrpl-wallet-standard/react/node_modules/@radix-ui/react-dialog/node_modules/@radix-ui/react-dismissable-layer/dist/index.mjs
var React11 = __toESM(require_react(), 1);

// node_modules/@xrpl-wallet-standard/react/node_modules/@radix-ui/react-dialog/node_modules/@radix-ui/react-primitive/dist/index.mjs
...
var DismissableLayer = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    const [node2, setNode] = React11.useState(null);
...
// node_modules/@xrpl-wallet-standard/react/node_modules/@radix-ui/react-dialog/node_modules/@radix-ui/react-focus-scope/dist/index.mjs
...
// node_modules/@xrpl-wallet-standard/react/node_modules/@radix-ui/react-dialog/node_modules/@radix-ui/react-portal/dist/index.mjs
...
// node_modules/@xrpl-wallet-standard/react/node_modules/@radix-ui/react-dialog/node_modules/@radix-ui/react-presence/dist/index.mjs
...
var SideCar = function(_a) {
  ...
  return React19.createElement(Target, __assign2({}, rest));
};
...
var RemoveScroll = React20.forwardRef(function(props, parentRef) {
  ...
  return React20.createElement(
    ...
    forwardProps ? React20.cloneElement(React20.Children.only(children), __assign2(__assign2({}, containerProps), { ref: containerRef })) : React20.createElement(Container, __assign2({}, containerProps, { className, ref: containerRef }), children)
  );
});
...
var ReactRemoveScroll = React26.forwardRef(function(props, ref) {
  return React26.createElement(RemoveScroll, __assign2({}, props, { ref, sideCar: sidecar_default }));
});
...
// node_modules/@xrpl-wallet-standard/app/dist/index.mjs
function getRegisterdXRPLWallets() {
  const wallets = getWallets().get();
  const xrplWallets = wallets.filter(
...
var useSignAndSubmitTransaction = () => {
  const wallet = useWalletStore((state) => state.currentWallet);
...
var useEvent = () => {
  ...
  const onChange = (listener) => {
    wallet == null ? void 0 : wallet.features["standard:events"].on("change", listener);
  };
  return { onChange };
};
var useWallet = () => {
...
var WalletListContainer = dt.ul`
  padding: 0;
  margin: 0;
`;
var WalletItem = dt.li`
  list-style: none;
  display: flex;
`;
var WalletButton = dt.button`
  display: flex;
  width: 100%;
  ...
  margin: 0.3rem;
`;
var WalletIcon = dt.img`
  height: 36px;
  vertical-align: middle;
`;
var WalletName = dt.span`
  vertical-align: middle;
`;
var WalletList = ({ onConnectSuccess, onConnectError }) => {
  ...
  return (0, import_jsx_runtime8.jsx)(WalletListContainer, { children: wallets.map((wallet) => (0, import_jsx_runtime8.jsx)(WalletItem, { children: (0, import_jsx_runtime8.jsxs)(WalletButton, { onClick: () => handleConnect(wallet), children: [
    (0, import_jsx_runtime8.jsx)(WalletIcon, { src: wallet.icon, alt: wallet.name }),
    (0, import_jsx_runtime8.jsx)(WalletName, { children: wallet.name })
  ] }) }, wallet.name)) });
};
...
var ConnectModal = ({ trigger }) => {
  ...
  return (0, import_jsx_runtime8.jsxs)(Root, { open, onOpenChange: setOpen, children: [
    (0, import_jsx_runtime8.jsx)(Trigger, { asChild: true, children: trigger }),
    (0, import_jsx_runtime8.jsxs)(Portal2, { children: [
      (0, import_jsx_runtime8.jsx)(DialogOverlay2, {}),
      (0, import_jsx_runtime8.jsxs)(DialogContent2, { "aria-describedby": void 0, onOpenAutoFocus: preventOpenAutoFocus, children: [
        (0, import_jsx_runtime8.jsx)(DialogTitle2, { children: "Connect to" }),
        (0, import_jsx_runtime8.jsx)(Description, {}),
        (0, import_jsx_runtime8.jsx)(WalletList, { onConnectSuccess: handleConnectSuccess, onConnectError: handleConnectError }),
        (0, import_jsx_runtime8.jsx)(Close, { asChild: true, children: (0, import_jsx_runtime8.jsx)(CloseButton, { "aria-label": "Close", children: (0, import_jsx_runtime8.jsx)(Cross2Icon, { width: 24, height: 24 }) }) })
      ] })
    ] })
  ] });
};
var DefaultConnectButton = dt.button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  border-radius: 4px;
...
var ConnectButton = (props) => {
  return (0, import_jsx_runtime8.jsx)(ConnectModal, { trigger: (0, import_jsx_runtime8.jsx)(DefaultConnectButton, { ...props, children: "Connect Wallet" }) });
};
var useAutoConnect = () => {
  const { connect } = useConnect();
...
function WalletProvider({ autoConnect = true, registerWallets, children }) {
  ...
  return (0, import_jsx_runtime8.jsx)(WalletContext.Provider, { value: storeRef.current, children: autoConnect ? (0, import_jsx_runtime8.jsx)(WalletAutoConnect, { children }) : children });
}
...
//# sourceMappingURL=@xrpl-wallet-standard_react.js.map
